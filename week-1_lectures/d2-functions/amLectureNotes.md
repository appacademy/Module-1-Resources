...
- Syntax
  ...
  - Code it out
    ...
    <!-- - [solution](./snippets/solutions/stringInit.js) -->
...
- Length
  ...
  - Code it out
    - `LEVEL UP!` - [whatLength](./snippets/whatLength.js)
    <!-- - [solution](./snippets/solutions/whatLength.js) -->
...
- Indexing Strings
  ...
  - Code it out
    - `LEVEL UP!` - [whatIdx](./snippets/whatIdx.js)
    <!-- - [solution](./snippets/solutions/whatIdx.js) -->
  
  - Concat
    - We can concatenate (join) strings together with `+`
...
- Syntax
  - `declaring` a function
    ...
    - Code it out
      ...
      <!-- - [solution](./snippets/solutions/writeAFunction.js) -->
  ...
  - `invoking` a function
    ...
    - Code it out
      ...
      <!-- - [solution](./snippets//solutions/callAFunction.js) -->
...
- Code it out
  - `LEVEL UP!` - [whatWillPrint](./snippets/whatWillPrint.js)
    <!-- - [solution](./snippets/solutions/whatWillPrint.js) -->
...
- Syntax
  ...
  - Code it out
    - [ifElsePrint](./snippets/ifElsePrint.js)
      <!-- - [solution](./snippets/solutions/ifElsePrint.js) -->
    - `LEVEL UP!` - [truthyFalsy](./snippets/truthyFalsy.js)
      - [Falsy Values](https://developer.mozilla.org/en-US/docs/Glossary/Falsy)
      <!-- - [solution](./snippets/solutions/truthyFalsy.js) -->
...
- `While Loop`
  - Syntax
    ...
    - Code it out
      ...
      <!-- - [solution](./snippets/solutions/firstWhile.js) -->
...
- `For Loop`
  - Syntax
    ...
    - Code it out
      ...
      <!-- - [solution]('./snippets/solutions/firstFor.js) -->
...
- Syntax
  ...
  - Code it out
    ...
    <!-- - [solution](./snippets/solutions/arrayInit.js) -->

- Indexing
  - Just like a string we can get a specific index with `bracket notation`
...
- Methods
  ...
  - `.concat(arr)` - allows us to join arrays together.
    ...
    - Code it out
      - `LEVEL UP!` - [concat](./snippets/concat.js)
      <!-- - [solution](./snippets/solutions/concat.js) -->
...
- Other common methods you will use often: (Not needed _today_, but why not take a look at them on MDN)
  ...
  - array.unshift()
  - array.slice(i, j)
  - array.splice(index, num, element(s))
