...
/*
  ...
  Use cases?
    - For issue that can be broken down into several smaller pieces, sub problem
    - fibonacci, factorial
    - search algorithms
...
//recurse(1) => returns 0                                        //when you return a function, you can pop off it the stack
//recurse(2) => returns 0
//recurse(3) => returns 0
//recurse(4) => returns 0
//recurse(5) => return 0
...
//reverse('cat') calls a reverse passing 'at' and want to concatenate the return value with the first letter
// we cant concatenate until the function were calling has a return
//reverse('cat') => reverse('at') + 'c'
//reverse('at') => reverse('t') + 'a'
//reverse('t') => reverse('') + 't'
//reverse(' ') => we just hit the base case return a an empty string => ' ';
//reverse('t') => ' ' + t => 't'
//reverse('at') => 't' + 'a' => 'ta'
