...
// Take a look at this example with a for loop blocking the thread: 
...
bigTime("first run", 75, 1)
setTimeout(bigTime, 50, "second run", 100, 2)
setTimeout(bigTime, 0, "third run", 125, 3)
